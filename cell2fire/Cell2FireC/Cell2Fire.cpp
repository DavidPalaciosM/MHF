...
bool Cell2Fire::RunIgnition(std::default_random_engine generator){
	...
	*******************************************************************/
	// Ignitions 
	int subloops = 0;
	////float raiz= sqrt(this->nCells);
	//// raiz = raiz + 0.5 - (raiz<0);
	//// int mid = (int)raiz;
	//int myints[] = {3232, 3233, 3234, 3235, 3236, 3237, 3238, 3332, 3333, 3334, 3335, 3336, 3337, 3338, 3432, 3433, 3434, 3435, 3436, 3437, 3438, 3532, 3533, 3534, 3535, 3536, 3537, 3538, 3632, 3633, 3634, 3635, 3636, 3637, 3638, 3732, 3733, 3734, 3735, 3736, 3737, 3738, 3832, 3833, 3834, 3835, 3836, 3837, 3838,3262, 3263, 3264, 3265, 3266, 3267, 3268, 3362, 3363, 3364, 3365, 3366, 3367, 3368, 3462, 3463, 3464, 3465, 3466, 3467, 3468, 3562, 3563, 3564, 3565, 3566, 3567, 3568, 3662, 3663, 3664, 3665, 3666, 3667, 3668, 3762, 3763, 3764, 3765, 3766, 3767, 3768, 3862, 3863, 3864, 3865, 3866, 3867, 3868,6232, 6233, 6234, 6235, 6236, 6237, 6238, 6332, 6333, 6334, 6335, 6336, 6337, 6338, 6432, 6433, 6434, 6435, 6436, 6437, 6438, 6532, 6533, 6534, 6535, 6536, 6537, 6538, 6632, 6633, 6634, 6635, 6636, 6637, 6638, 6732, 6733, 6734, 6735, 6736, 6737, 6738, 6832, 6833, 6834, 6835, 6836, 6837, 6838,6262, 6263, 6264, 6265, 6266, 6267, 6268, 6362, 6363, 6364, 6365, 6366, 6367, 6368, 6462, 6463, 6464, 6465, 6466, 6467, 6468, 6562, 6563, 6564, 6565, 6566, 6567, 6568, 6662, 6663, 6664, 6665, 6666, 6667, 6668, 6762, 6763, 6764, 6765, 6766, 6767, 6768, 6862, 6863, 6864, 6865, 6866, 6867, 6868};
	////int myints[] = {1,2,3,4,mid+1,mid+2,mid+3,mid+4,2*mid+1,2*mid+2,2*mid+3,2*mid+4,3*mid+1,3*mid+2,3*mid+3,3*mid+4,mid/2-3,mid/2-2,mid/2-1,mid/2,mid/2+1,mid/2+2,mid/2+3, mid/2+mid-3, mid/2+mid-2, mid/2+mid-1, mid/2+mid, mid/2+mid+1, mid/2+mid+2, mid/2+mid+3,mid/2+mid*2-3, mid/2+mid*2-2, mid/2+mid*2-1, mid/2+mid*2, mid/2+mid*2+1, mid/2+mid*2+2, mid/2+mid*2+3,mid/2+mid*3-3, mid/2+mid*3-2, mid/2+mid*3-1, mid/2+mid*3, mid/2+mid*3+1, mid/2+mid*3+2, mid/2+mid*3+3,mid-3,mid-2,mid-1,mid,2*mid-3,2*mid-2,2*mid-1,2*mid,3*mid-3,3*mid-2,3*mid-1,3*mid,4*mid-3,4*mid-2,4*mid-1,4*mid,((this->nCells)/2)+1,((this->nCells)/2)+1-mid,((this->nCells)/2)+1-mid+1,((this->nCells)/2)+1-mid+2,((this->nCells)/2)+1-mid+3,((this->nCells)/2)+1-mid*2,((this->nCells)/2)+1-mid*2+1,((this->nCells)/2)+1-mid*2+2,((this->nCells)/2)+1-mid*2+3,((this->nCells)/2)+1-mid*3,((this->nCells)/2)+1-mid*3+1,((this->nCells)/2)+1-mid*3+2,((this->nCells)/2)+1-mid*3+3,((this->nCells)/2)+2,((this->nCells)/2)+3,((this->nCells)/2)+4 ,((this->nCells)/2)+1+mid,((this->nCells)/2)+1+mid+1,((this->nCells)/2)+1+mid+2,((this->nCells)/2)+1+mid+3,((this->nCells)/2)+1+mid*2,((this->nCells)/2)+1+mid*2+1,((this->nCells)/2)+1+mid*2+2,((this->nCells)/2)+1+mid*2+3,((this->nCells)/2)+1+mid*3,((this->nCells)/2)+1+mid*3+1,((this->nCells)/2)+1+mid*3+2,((this->nCells)/2)+1+mid*3+3 ,((this->nCells)/2)+mid,((this->nCells)/2)+mid-1,((this->nCells)/2)+mid-2,((this->nCells)/2)+mid-3,((this->nCells)/2)+mid-mid,((this->nCells)/2)+mid-mid-3,((this->nCells)/2)+mid-mid-2,((this->nCells)/2)+mid-mid-1,((this->nCells)/2)+mid-mid*2,((this->nCells)/2)+mid-mid*2-3,((this->nCells)/2)+mid-mid*2-2,((this->nCells)/2)+mid-mid*2-1,((this->nCells)/2)+mid-mid*3,((this->nCells)/2)+mid-mid*3-3,((this->nCells)/2)+mid-mid*3-2,((this->nCells)/2)+mid-mid*3-1,((this->nCells)/2)+mid+mid,((this->nCells)/2)+mid+mid-1,((this->nCells)/2)+mid+mid-2,((this->nCells)/2)+mid+mid-3,((this->nCells)/2)+mid+mid*2,((this->nCells)/2)+mid+mid*2-1,((this->nCells)/2)+mid+mid*2-2,((this->nCells)/2)+mid+mid*2-3,((this->nCells)/2)+mid+mid*3,((this->nCells)/2)+mid+mid*3-1,((this->nCells)/2)+mid+mid*3-2,((this->nCells)/2)+mid+mid*3-3, (this->nCells)-mid+1,(this->nCells)-mid+1-3*mid,(this->nCells)-mid+1-3*mid+1,(this->nCells)-mid+1-3*mid+2,(this->nCells)-mid+1-3*mid+3,(this->nCells)-mid+1-2*mid,(this->nCells)-mid+1-2*mid+1,(this->nCells)-mid+1-2*mid+2,(this->nCells)-mid+1-2*mid+3,(this->nCells)-mid+1-mid,(this->nCells)-mid+1-mid+1,(this->nCells)-mid+1-mid+2,(this->nCells)-mid+1-mid+3,(this->nCells)-mid+2,(this->nCells)-mid+3,(this->nCells)-mid+4,(this->nCells)-mid/2,(this->nCells)-mid/2-mid*3-3,(this->nCells)-mid/2-mid*3-2,(this->nCells)-mid/2-mid*3-1,(this->nCells)-mid/2-mid*3,(this->nCells)-mid/2-mid*3+1,(this->nCells)-mid/2-mid*3+2,(this->nCells)-mid/2-mid*3+3,(this->nCells)-mid/2-mid*2-3,(this->nCells)-mid/2-mid*2-2,(this->nCells)-mid/2-mid*2-1,(this->nCells)-mid/2-mid*2,(this->nCells)-mid/2-mid*2+1,(this->nCells)-mid/2-mid*2+2,(this->nCells)-mid/2-mid*2+3,(this->nCells)-mid/2-mid-3,(this->nCells)-mid/2-mid-2,(this->nCells)-mid/2-mid-1,(this->nCells)-mid/2-mid,(this->nCells)-mid/2-mid+1,(this->nCells)-mid/2-mid+2,(this->nCells)-mid/2-mid+3,(this->nCells)-mid/2-3,(this->nCells)-mid/2-2,(this->nCells)-mid/2-1,(this->nCells)-mid/2+1,(this->nCells)-mid/2+2,(this->nCells)-mid/2+3,this->nCells,this->nCells-3*mid-3,this->nCells-3*mid-2,this->nCells-3*mid-1,this->nCells-3*mid,this->nCells-2*mid-3,this->nCells-2*mid-2,this->nCells-2*mid-1,this->nCells-2*mid,this->nCells-mid-3,this->nCells-mid-2,this->nCells-mid-1,this->nCells-mid,this->nCells-3,this->nCells-2,this->nCells-1};
	//std::random_device rd;
	//std::mt19937 mt(rd());
	//std::uniform_int_distribution<int> distribution(0, (sizeof(myints) / sizeof(myints[0]))-1);
	//std::uniform_int_distribution<int> distribution2(1, this->nCells);
	//creamos una lista con todos los puntos de ignicion posibles y hacemos un random del 1 al largo de la lista con esos puntos. el random nos tirara un numero y ponemos como punto de ignicion el indice de esa lista
